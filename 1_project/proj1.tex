...
\author{Simona Češková \\ \href{mailto:xcesko00@stud.fit.vutbr.cz}{xcesko00@stud.fit.vutbr.cz}}
\date{}
\begin{document}
...
\begin{quotation}
Čím více {\it druhů}, {\bf řezů}, {\tiny velikostí},
\textcolor{red}{barev} písma a~jiných \textsc{efektů} použijeme, tím \texttt{profesionálněji} bude {\Large\fontfamily{pzc}\selectfont dokument} vypadat.
{\huge Č}{\LARGE t}{\Large e}{\large n}{\normalsize á}{\small ř} {\footnotesize t}{\scriptsize í}{\tiny m} bude vždy {\huge\bf{nadšen!}}
\end{quotation}
...
V~\LaTeX u ji sázíme raději příkazem \verb!\emph{text}!
než \verb!\textit{text}!.
...
V~češtině se používají uvozovky typu \uv{9966} místo anglických 
...
Pro systematické doplnění vlnek slouží volně šiřitelný program {\it vlna} od pana Olšáka\footnote{Viz \url{http://petr.olsak.net/ftp/olsak/vlna/}}.
